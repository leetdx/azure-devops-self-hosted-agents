...
This repository provides a reference architecture with documentation links for deploying secure Azure DevOps self-hosted agents as Docker containers within Azure Container Instances, focusing on enterprise network integration with Private Endpoints, Private DNS zones, and Azure Firewall configurations, where agents are authenticated using Azure App Registration service principals.
