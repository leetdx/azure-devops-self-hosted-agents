...
if ($UseNightlies) {
    ...
    foreach ($Bundle in $Bundles) {
        ...
        $CodeQLBundlePath = Get-DownloadWithRetry -Url "https://github.com/github/codeql-action/releases/download/$($Bundle.TagName)/codeql-bundle-win64.tar.gz" -Name "codeql-bundle-win64.tar.gz"
